...
!function($){
  ...
  $.fn.flipout_cards = function(options){
    ...
    return this.each(function(){
      ...
      $('.memo-popup').hover( function() {
		//console.log("beforeOpen");

		var maskHeight = $(document).height();
		var maskWidth = $(window).width();
		$('#overLayer').fadeIn('slow').css({'width':maskWidth,'height':maskHeight,'display':'block'});
        if (typeof settings.beforeOpen == 'function') settings.beforeOpen();
        el.addClass( "foc-open" );
