...
<body>
	<div id="wrapper">
		<div class="container">
			<form class="form-horizontal" name="frm1" id="frm1" method="post" enctype="multipart/form-data" action="/letech/aprv/aprv00List.do">
					...
					<div class="form-container">
						...
						<div class="section">
							...
							<div id="nopFuelType">
								<div class="form-group row fuelType">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" id="nopUnlead" name="nopUnlead">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label" for="nopVia">경유</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="nopVia" name="nopVia">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label" for="nopLPG">LPG</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="nopLPG" name="nopLPG">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="section">
							...
							<div id="fleff">
								<div class="form-group row fuelType">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" id="fleffUnlead" name="fleffUnlead">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label" for="fleffVia">경유</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="fleffVia" name="fleffVia">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label" for="fleffLPG">LPG</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="fleffLPG" name="fleffLPG">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="section">
							...
							<div id="kmPer">
								<div class="form-group row fuelType">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" id="kmPerUnlead" name="kmPerUnlead">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label control-label" for="kmPerVia">경유</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="kmPerVia" name="kmPerVia">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label control-label" for="kmPerLPG">LPG</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="nopLPG" name="kmPerLPG">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row col-lg-12">
							<span class="pull-right">
								<input type="button" id="btn-ok" name="btn-ok" class="btn btn-sm btn-info" value="저장">
					...
					<div class="form-container">
						...
						<div class="section">
							...
							<div id="nopFuelType">
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label" for="nopUnlead">무연</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="nopUnlead" name="nopUnlead" value="1670">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label" for="nopVia">경유</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="nopVia" name="nopVia" value="1480">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label" for="nopLPG">LPG</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="nopLPG" name="nopLPG" value="1000">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="section">
							...
							<div id="fleff">
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label" for="fleffUnlead">무연</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="fleffUnlead" name="fleffUnlead" value="13.0">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label" for="fleffVia">경유</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="fleffVia" name="fleffVia" value="14.0">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label" for="fleffLPG">LPG</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="fleffLPG" name="fleffLPG" value="9.0">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="section" id="depreciation-div">
							<div class="form-group row">
								...
								<div id="depreciation">
									<div class="col-sm-3">
										<input type="text" class="form-control" value="1670">
									</div>
									<div class="col-sm-1 text-center vh-100">
										<p>X</p>
									</div>
						...
						<div class="section">
							...
							<div id="kmPer">
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label control-label" for="kmPerUnlead">무연</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="kmPerUnlead" name="kmPerUnlead" value="170.00">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label control-label" for="kmPerVia">경유</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="kmPerVia" name="kmPerVia" value="150.00">
									</div>
								</div>
								<div class="form-group row fuelType">
									<label class="col-sm-2 control-label control-label" for="kmPerLPG">LPG</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" id="nopLPG" name="kmPerLPG" value="160.00">
									</div>
								</div>
							</div>
						</div>
