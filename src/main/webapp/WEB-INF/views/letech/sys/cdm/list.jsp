...
<div id="wrap">
		...
		<!-- page -->
			<article>
		<p class="col_md_12">
			<a href="#" class="button-a btn btn_info full-right" onclick="fnInsert();">코드추가</a>
		</p>
			<!-- 테이블 -->
						...
						<c:otherwise>
							<c:forEach var="highList" items="${highList }">
								...
								<c:choose>
									...
									<td>
										<font>
											<a href="#" class="button-a btn_s btn_default" onclick="fnModify('${highList.CD}');">코드수정</a>
											<a href="#" class="button-a btn_s btn_default" onclick="fnDelete('<%=VarConsts.MODE_DA%>','${highList.CD}','1');">코드삭제</a>
											<a href="#" class="button-a btn_s btn_default" onclick="fnLowInsert('${highList.CD}');">하위코드추가</a>
										</font>
									</td>
								</tr>
										...
										<c:if test="${highList.CD eq lowList.UP_CD }">
											...
											<c:choose>
												<c:when test="${lowList.CD eq fn:substring(params.up_cd, 0, 9) }" >
													<span class="re_re"></span> <label class="glyphicon glyphicon-minus-sign"></label> ${lowList.CD }
												</c:when>
												<c:otherwise>
												...
												<td  class="list_tow">
													<font>
														<a href="#" class="btn_s btn_info" onclick="fnModify('${lowList.CD}')">코드수정</a>
														<a href="#" class="btn_s btn_info" onclick="fnDelete('<%=VarConsts.MODE_D%>','${lowList.CD}','2');">코드삭제</a>
														<a href="#" class="btn_s btn_info" onclick="fnLowInsert('${lowList.CD}');">하위코드추가</a>
													</font>
												</td>
											</tr>
												...
												<c:forEach var="lowList2" items="${lowList2 }">
													<c:if test="${lowList.CD eq lowList2.UP_CD }">
														...
														<c:choose>
															...
															<td class="list_three" > 
																<font>
																	<a href="#" class="btn_s btn_basic" onclick="fnModify('${lowList2.CD}')">코드수정</a>
																	<a href="#" class="btn_s btn_basic" onclick="fnDelete('<%=VarConsts.MODE_D%>','${lowList2.CD}','2');">코드삭제</a>
																	<a href="#" class="btn_s btn_basic" onclick="fnLowInsert('${lowList2.CD}');">하위코드추가</a>
																</font>
															</td>
														</tr>
																...
																<c:if test="${lowList2.CD eq lowList3.UP_CD }">
																	...
																	<c:choose>
																		<c:when test="${lowList3.CD eq fn:substring(params.up_cd, 0, 15) }" >
																			<font ><span><img src="<%=request.getContextPath()%>/resources/images/layout/tree_tow.png" alt="검색"  > </span><label class="glyphicon glyphicon-minus-sign"></label> ${lowList3.CD }</font>
																		</c:when>
																		<c:otherwise>
																			<font ><span><img src="<%=request.getContextPath()%>/resources/images/layout/tree_tow.png" alt="검색"  > </span><label class="glyphicon glyphicon-plus-sign"></label> ${lowList3.CD }</font>
																		</c:otherwise>
																	</c:choose>
																		</td>
																		<td class="list_four">
																		...
																		<td class="list_four"> 
																			<font>
																				<a href="#" class="btn_s btn_default" onclick="fnModify('${lowList3.CD}')">코드수정</a>
																				<a href="#" class="btn_s btn_default" onclick="fnDelete('<%=VarConsts.MODE_D%>','${lowList3.CD}','2');">코드삭제</a>
																			</font>
																		</td>
																	</tr>
																</c:if>
