...
<body class="pop">
	...
	<div class="col-lg-12 form-group" style="padding : 0 20px 0 20px;">
		<div class="col-lg-2 col-sm-2 text-left">
		</div>
		<div class="table-responsive col-lg-9 text-right">
			<span>
				<input type="button" id="btn-cancel" name="btn-cancel" class="btn btn-sm btn-default" onclick="window.self.close();"  value="닫기" />
			</span>
		</div>
	</div>
