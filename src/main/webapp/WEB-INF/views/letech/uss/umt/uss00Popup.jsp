									...
									<c:forEach var="list" items="${resultList}" varStatus="status">
										<tr>
											...
											<td style="text-align: left;">&nbsp;
												<a href="#" onclick="javascript:setData('${list.USS_ID}', '${list.USS_NM }', '${list.USS_AUTH_NM }', '${list.DP_NM }', '${list.USS_AUTH_CD}', '${list.DP_CD}' );">${list.USS_ID}</a>
											</td>
											<td>${list.USS_NM}</td>
...
function setData(id, nm, auth_nm, dept_nm, auth_cd, dept_cd){
	$(opener.location).attr("href", "javascript:setUssForm('"+id+"', '"+nm+"', '"+auth_nm+"', '"+dept_nm+"', '"+auth_cd+"', '"+dept_cd+"')");
	window.close();
}
</script>
</body>
